...
!define PYFILENAME python-2.5.msi
!define PYWINFILENAME pywin32-212.win32-py2.5.exe
!define RFILENAME R-2.7.1-win32.exe
!define RPYFILENAME rpy-1.0.3-R-2.7.0-win32-py2.5.exe

!define OUTFILENAME red-1.0-installer.exe
...
Section Uninstall
	...
	ReadRegStr $PythonDir HKLM Software\Python\PythonCore\2.5\InstallPath ""
	${If} $PythonDir != ""
		DeleteRegKey HKLM "SOFTWARE\Python\PythonCore\2.5\PythonPath\Orange"
		DeleteRegKey HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Orange"
	${Else}
		DeleteRegKey HKCU "SOFTWARE\Python\PythonCore\2.5\PythonPath\Orange"
...
!macro GetPythonDir
    ${If} $AdminInstall == 0
	    ReadRegStr $PythonDir HKCU Software\Python\PythonCore\2.5\InstallPath ""
...
Section ""
	...
	WriteRegStr SHELL_CONTEXT "SOFTWARE\Python\PythonCore\2.5\PythonPath\Orange" "" "$INSTDIR;$INSTDIR\OrangeWidgets;$INSTDIR\OrangeCanvas"
