...
class prcomp(OWRpy): 
    ...
    def __init__(self, parent=None, signalManager=None):
        ...
        self.outputs = [("prcomp Output", RvarClasses.RModelFit), ("Scaled Data", RvarClasses.RMatrix)]
    ...
    def commitFunction(self):
        ...
        newPRComp = RvarClasses.RModelFit(data = self.Rvariables['prcomp'])
        self.rSend("prcomp Output", newPRComp)
        newPRCompMatrix = RvarClasses.RMatrix(data = self.Rvariables['prcomp']+'$x')
