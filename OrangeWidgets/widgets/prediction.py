...
class prediction(OWRpy): 
	...
	def __init__(self, parent=None, signalManager=None):
		...
		self.inputs = [("labels", RvarClasses.RVector, self.processlabels),("predictions", RvarClasses.RVector, self.processpredictions)]
		self.outputs = [("prediction Output", RvarClasses.RModelFit)]
	...
	def commitFunction(self):
		...
		newData = RvarClasses.RModelFit(data = self.Rvariables["prediction"]) # moment of variable creation, no preexisting data set.  To pass forward the data that was received in the input uncomment the next line.
