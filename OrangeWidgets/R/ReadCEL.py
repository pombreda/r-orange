...
class ReadCEL(OWWidget):
	def __init__(self, parent=None, signalManager=None):
		...
		#celfilepath = None #sets the celfilepath to the current wd, not that there should be anything in there that it can read but it's better than nothing
		self.rand = 'random'
		self.FD = 'choose.dir()'
