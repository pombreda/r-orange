...
class panpCalls(OWWidget):
	...
	def processEset(self):
		...
		r('PA<-pa.calls('+self.data+', looseCutoff='+self.looseCut+', tightCutoff='+self.tightCut+')')
		...
		r('peset_'+str(self.rand)+'<-exprs('+self.data+')[Present,]')
