...
class normalize_quantiles(OWRpy): 
    ...
    def __init__(self, parent=None, signalManager=None):
        ...
        # self.RFUnctionParamcopy_lineEdit =  redRGUI.lineEdit(self.advancedTab, label = "copy:")
    ...
    def commitFunction(self):
        ...
        self.rSend("normalize.quantiles Output", {"data":'as.data.frame('+self.Rvariables["normalize.quantiles"]+')'})
