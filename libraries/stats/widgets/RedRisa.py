...
class RedRisa(OWRpy): 
    ...
    def commitFunction(self):
        ...
        newData = redRRModelFit(self, data = self.Rvariables["isa"]) # moment of variable creation, no preexisting data set.  To pass forward the data that was received in the input uncomment the next line.
