"""RModelFit
.. helpdoc::
The RModelFit signal contains fits to models.  These are generally generated by fitting some kind of model and are most likely to actually be lists."""
#  RvarClass for Generic Model Fit, inherits from list, other model fits should inherit from this class

"""
.. convertTo:: `base:RList, base:RVariable`
.. convertFrom:: ``
"""
