...
class commitButton(button,widgetState):
    ...
    toolTip=None, width = None, height = None,align='left', toggleButton = False, addToLayout = 1):
        button.__init__(self, widget = widget, label = label, callback = callback, disabled = disabled, icon = str(redREnviron.directoryNames['libraryDir']+'/base/icons/fork.png').replace('\\', '/'), toolTip = toolTip, width = width, height = 35, align = align, toggleButton = toggleButton, addToLayout = addToLayout)
