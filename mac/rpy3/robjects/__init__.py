...
def default_ri2py(o):
    """ Convert :class:`rpy3.rinterface.Sexp` to higher-level objects,
    without copying the R objects.

    :param o: object
    :rtype: :class:`rpy3.robjects.RObject (and subclasses)`
    """
...
def default_py2ri(o):
    """ Convert arbitrary Python object to :class:`rpy3.rinterface.Sexp` to objects,
    creating an R object with the content of the Python object in the process
    (wich means data copying).

    :param o: object
    :rtype: :class:`rpy3.rinterface.Sexp` (and subclasses)
    ...
    def setenvironment(self, val):
        ...
        if not isinstance(val, rinterface.SexpEnvironment):
            raise ValueError("The environment must be an instance of" +
                             " rpy3.rinterface.Sexp.environment")
