...
import rpy3.robjects.lib
import rpy3.robjects.conversion as conversion
from rpy3.robjects.functions import SignatureTranslatedFunction
from rpy3.robjects import NULL
...
class Package(object):
    ...
    def __update_dict__(self):
        ...
        for elt in self._rpy3r:
            del(self.__dict__[elt])
        self._rpy3r = {}
        self.__fill_rpy3r__()

    def __fill_rpy3r__(self):
        """ Fill the attribute _rpy3r """
        name = self.__rname__
...
class SignatureTranslatedPackage(Package):
    def __fill_rpy3r__(self):
        super(SignatureTranslatedPackage, self).__fill_rpy3r__()
