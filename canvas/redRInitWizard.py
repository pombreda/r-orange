...
class RedRInitWizard(QWizard):
    def __init__(self, parent = None):
        ...
        self.rlibrariesBox = redRGUI.groupBox(self.RSetupPage, 'R Libraries')
        ...
        self.showAtStartup = redRGUI.checkBox(self.runExamplePage, buttons = ['Don\'t Show at Startup'])
        self.showAtStartup.setChecked('Don\'t Show at Startup')
        self.showExample = redRGUI.checkBox(self.runExamplePage, buttons = ['Start Example'])
